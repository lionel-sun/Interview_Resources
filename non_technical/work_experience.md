...
- 拼多多
  ...
  - 国内体系比较完善，主要是运维和迭代。同时掌握了规范的数仓体系建设。
  ...
  - 架构设计，规范和治理
- 字节跳动
  - 管理：新人入职，转岗等。方向规划，需求承接，流程优化。
  - 营收互动数据域建设，主要收入来源产品。包括连麦，pk等多个主播间互动玩法。基础建设，原子指标建设。计算优化，存储优化。
  - EU，US和其他区域机房的数据合规。
  - 大项目eoy和moy活动，输出sop可复用。
  - ai大模型适配，通过数据建设文档的输入，可以机器人自动回答用户找数问题。
