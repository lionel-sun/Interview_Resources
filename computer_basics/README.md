...
1024字节bytes = 1KB 	1024KB = 1MB	1024MB = 1GB
...
相应：status（HTTP 版本和状态码），date，server（服务器），last modified，E tag，accept ranges，content length，connection，content type
